...
//
// Here we model age-specific survival separately in hand-reared and wild-raised 
// birds (not as an age-specific, additive effect on the logit scale, as in 
// 04_td_tr_hr.stan, 05_td_tr_hr_phi-im.stan, 06_td_tr-bss_hr_phi-im.stan).
// 
...
parameters {
  ...
  array[3] vector<lower=0, upper=1>[T-1] phi_jv_hr;   // for juveniles (0 yrs old) 
  array[3] vector<lower=0, upper=1>[T-1] phi_ad_hr;   // for immatures, adults (1, 2+ yrs old)
